                                        ...
                                        <div className="flex rounded-lg border-gray-200 p-8 sm:flex-row flex-col bg-white shadow-sm">
                                            <div className="flex-grow">
                                                <div className="flex justify-between items-start">
                                                    ...
                                                    <div>
                                                        ...
                                                        <Link href={route("post.edit", post.id)}>
                                                            <IconButton
                                                                className="hover:bg-blue-400 bg-blue-500 active:bg-blue-600"
                                                            >
                                                        ...
                                                        {/* 削除ボタン */}
                                                        <IconButton
                                                            className="hover:bg-red-400 bg-red-500 active:bg-red-600"
                                                            onClick={() =>
                                                ...
                                                <div className="flex justify-between">
                                                    <Link
                                                        className="mt-3 text-green-500 hover:text-green-400 active:text-green-600 inline-flex items-center"
